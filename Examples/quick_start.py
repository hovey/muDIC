...
# path = r'./example_data/' # Use this formatting on Linux and macOS
path = Path(__file__).parent / "example_data"  # for all operating systems
...
images = dic.IO.image_stack_from_folder(str(path), file_type=".tif")
